...
真錢 IAP（**2026-07-11 定價定案**：`diamonds_100/350/1200` 三個 SKU id 不變，
TWD 30/90/290、內容物 100/350/**1300**（大包 1200→1300，`migration_20260711b.sql`）；
`remove_ads_forever` TWD 72 維持不變）。
