...
#### 真人試玩回饋（2026-06-15 晚）→ 明天待辦（尚未動工，依重要性排序）
...
5. **陡坡爬不上去卡住（截圖那種陡坡，車直接卡住；大盤速度慢更明顯）**
   - 原則：**只要不是 90° 都該爬得上去**。
   - 方向：加大驅動力（`DRIVE.accel` / `rearWheelSpin`），或上坡給額外助力；或降 `TRACK.maxSlopeDeg` 保證可爬。與第 4 點一起調（陡到有戲、但仍爬得上）。
