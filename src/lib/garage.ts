...
export const COSMETIC_LABELS: Record<string, { label: string; swatch?: string }> = {
  ...
  "title:finance-haojiao": { label: "皓哥黃段子聽眾" },
  "title:chives": { label: "韭菜" },
  "title:fourth-institution": { label: "第四大法人" },
  "title:bulls-win-eventually": { label: "本多終勝" },
  "title:ba-nini": { label: "巴膩膩" },
  "title:short-squeeze-escape": { label: "軋空逃生" },
  "title:four-generations-debt": { label: "四貸同堂" },
  "title:nano-shareholder": { label: "奈米戶" },
  "title:allin-wisdom": { label: "梭哈是種智慧" },
  "title:buy-the-dip": { label: "逢低買進" },
  "title:park-bench-resident": { label: "公園長椅居民" },
