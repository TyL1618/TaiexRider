...
const COSMETIC_CATALOG: Record<CosmeticKind, CosmeticOption[]> = {
  ...
  title: [
    ...
    { id: "title:finance-haojiao", label: "皓哥黃段子聽眾", price: 200 },
    { id: "title:chives", label: "韭菜", price: 200 },
    { id: "title:fourth-institution", label: "第四大法人", price: 200 },
    // 2026-07-21 追加（同日第八批）：使用者新增 8 個股市梗稱號。
    { id: "title:bulls-win-eventually", label: "本多終勝", price: 200 },
    { id: "title:ba-nini", label: "巴膩膩", price: 200 },
    { id: "title:short-squeeze-escape", label: "軋空逃生", price: 200 },
    { id: "title:four-generations-debt", label: "四貸同堂", price: 200 },
    { id: "title:nano-shareholder", label: "奈米戶", price: 200 },
    { id: "title:allin-wisdom", label: "梭哈是種智慧", price: 200 },
    { id: "title:buy-the-dip", label: "逢低買進", price: 200 },
    { id: "title:park-bench-resident", label: "公園長椅居民", price: 200 },
